...
class Registry:
    ...
    def __init__(self, al_descartar=None):
        self._jobs = {}
        self._lock = threading.Lock()
        # Se avisa cuando un trabajo se descarta, para que quien haya dejado
        # archivos asociados (el ZIP de un paquete) los pueda borrar. Sin esto,
    ...
    def limpiar(self):
        ...
        # a quien esté consultando el estado de otro trabajo.
        for k in viejos:
